...
const tests = [
    ...
    { cmd: '/cheap', expect: /Самые дешёвые/ },
    ...
    { cmd: '/d 55', expect: /55".*карт/s },
    { cmd: '/d 75', expect: /75".*карт/s },
    { cmd: '/d 32', expect: /32".*карт/s },
    { cmd: '/d', expect: /Выберите диагональ/ },
    { cmd: '/under 30000', expect: /30[\s ]?000.*карт/s },
    { cmd: '/under 100000', expect: /100[\s ]?000.*карт/s },
    { cmd: '/under', expect: /Выберите потолок/ },
    { cmd: '/find qled', expect: /найдено/i },
    { cmd: '/find 4k', expect: /найдено/i },
